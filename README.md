...
- Download [the mod](https://github.com/luckycdev/SSD_Demo_Fixer/releases/latest) and put it in the newly created Mods/ folder in the Slowly Sliding Ducks Demo game files
- Run the game!
...
*First 3 steps are to get required dependencies for building
